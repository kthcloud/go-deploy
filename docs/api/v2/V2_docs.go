        ...
        "schemas": {
            ...
            "body.ClusterCapacities": {
                "properties": {
                    ...
                    "cpuCore": {
                        "$ref": "#/components/schemas/body.CpuCoreCapacities"
                    },
                    "gpu": {
                        "$ref": "#/components/schemas/body.GpuCapacities"
                    },
                    "ram": {
                        "$ref": "#/components/schemas/body.RamCapacities"
                    }
                },
                "type": "object"
            },
            ...
            "body.CpuStatus": {
                "properties": {
                    "load": {
                        "$ref": "#/components/schemas/body.CpuStatusLoad"
                    },
                    "temp": {
                        "$ref": "#/components/schemas/body.CpuStatusTemp"
                    }
                },
                "type": "object"
            },
            ...
            "body.DeploymentCreate": {
                "properties": {
                    ...
                    "gpus": {
                        "items": {
                            "$ref": "#/components/schemas/body.DeploymentGPU"
                        },
                        "minItems": 0,
                        "type": "array",
                        "uniqueItems": false
                    ...
                    "neverStale": {
                        "description": "Boolean to make deployment never get disabled, despite being stale",
                        "type": "boolean"
                    },
                    "private": {
            ...
            "body.DeploymentRead": {
                "properties": {
                    ...
                    "specs": {
                        "$ref": "#/components/schemas/body.DeploymentSpecs"
                    },
                    "status": {
                        "type": "string"
                    },
            ...
            "body.GpuClaimCreate": {
                "properties": {
                    ...
                    "requested": {
                        "description": "Requested contains all requested GPU configurations by key (request.Name).",
                        "items": {
                            "$ref": "#/components/schemas/body.RequestedGpuCreate"
                        },
                        "minItems": 1,
                        "type": "array",
                        "uniqueItems": false
            ...
            "body.GpuClaimRead": {
                "properties": {
                    "allocated": {
                        "additionalProperties": {
                            "items": {
                                "$ref": "#/components/schemas/body.AllocatedGpu"
                            },
                            "type": "array"
                        },
                        "description": "Allocated contains the GPUs that have been successfully bound/allocated.",
                        "type": "object"
                    },
                    "allowedRoles": {
                        "description": "Roles allowed to use this GpuClaim, empty means all",
                        "items": {
                            "type": "string"
                        },
                        "type": "array",
                    ...
                    "consumers": {
                        "description": "Consumers are the workloads currently using this claim.",
                        "items": {
                            "$ref": "#/components/schemas/body.GpuClaimConsumer"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    ...
                    "lastError": {
                        "description": "LastError holds the last reconciliation or provisioning error message.",
                        "type": "string"
                    },
                    "name": {
                        "type": "string"
                    ...
                    "requested": {
                        "additionalProperties": {
                            "$ref": "#/components/schemas/body.RequestedGpu"
                        },
                        "description": "Requested contains all requested GPU configurations by key (request.Name).",
                        "type": "object"
                    },
                    "status": {
                        "$ref": "#/components/schemas/body.GpuClaimStatus"
                    },
                    "updatedAt": {
                        "type": "string"
                    },
            ...
            "body.GpuClaimStatus": {
                "description": "Status reflects the reconciliation and/or lifecycle state.",
                "properties": {
                    "lastSynced": {
                        "type": "string"
                    },
            ...
            "body.GpuDeviceConfigurationWrapper": {
                "type": "object"
            },
            "body.GpuGroupRead": {
                "properties": {
            ...
            "body.GpuStatus": {
                "properties": {
                    "temp": {
                        "items": {
                            "$ref": "#/components/schemas/body.GpuStatusTemp"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "body.HostStatus": {
                "properties": {
                    "cpu": {
                        "$ref": "#/components/schemas/body.CpuStatus"
                    },
                    "gpu": {
                        "$ref": "#/components/schemas/body.GpuStatus"
                    },
                    "ram": {
                        "$ref": "#/components/schemas/body.RamStatus"
                    }
                },
                "type": "object"
            },
            ...
            "body.K8sStats": {
                "properties": {
                    "clusters": {
                        "items": {
                            "$ref": "#/components/schemas/body.ClusterStats"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "body.PortCreate": {
                "properties": {
                    "httpProxy": {
                        "$ref": "#/components/schemas/body.HttpProxyCreate"
                    },
                    "name": {
                        "maxLength": 100,
                        "minLength": 1,
            ...
            "body.PortRead": {
                "properties": {
                    ...
                    "httpProxy": {
                        "$ref": "#/components/schemas/body.HttpProxyRead"
                    },
                    "name": {
                        "type": "string"
                    },
            ...
            "body.PortUpdate": {
                "properties": {
                    "httpProxy": {
                        "$ref": "#/components/schemas/body.HttpProxyUpdate"
                    },
                    "name": {
                        "maxLength": 100,
                        "minLength": 1,
            ...
            "body.RamStatus": {
                "properties": {
                    "load": {
                        "$ref": "#/components/schemas/body.RamStatusLoad"
                    }
                },
                "type": "object"
            },
            ...
            "body.RequestedGpu": {
                "properties": {
                    ...
                    "config": {
                        "$ref": "#/components/schemas/body.GpuDeviceConfigurationWrapper"
                    },
                    "count": {
                        "type": "integer"
                    },
            ...
            "body.SystemCapacities": {
                "properties": {
                    "clusters": {
                        ...
                        "items": {
                            "$ref": "#/components/schemas/body.ClusterCapacities"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    ...
                    "hosts": {
                        ...
                        "items": {
                            "$ref": "#/components/schemas/body.HostCapacities"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "body.SystemStats": {
                "properties": {
                    "k8s": {
                        "$ref": "#/components/schemas/body.K8sStats"
                    }
                },
                "type": "object"
            },
            "body.SystemStatus": {
                "properties": {
                    "hosts": {
                        "items": {
                            "$ref": "#/components/schemas/body.HostStatus"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "body.TimestampedSystemCapacities": {
                "properties": {
                    "capacities": {
                        "$ref": "#/components/schemas/body.SystemCapacities"
                    },
                    "timestamp": {
                        "type": "string"
                    }
            ...
            "body.TimestampedSystemStats": {
                "properties": {
                    "stats": {
                        "$ref": "#/components/schemas/body.SystemStats"
                    },
                    "timestamp": {
                        "type": "string"
                    }
            ...
            "body.TimestampedSystemStatus": {
                "properties": {
                    "status": {
                        "$ref": "#/components/schemas/body.SystemStatus"
                    },
                    "timestamp": {
                        "type": "string"
                    }
            ...
            "body.VmRead": {
                "properties": {
                    ...
                    "gpu": {
                        "$ref": "#/components/schemas/body.VmGpuLease"
                    },
                    "host": {
                        "type": "string"
                    },
                    ...
                    "ports": {
                        "items": {
                            "$ref": "#/components/schemas/body.PortRead"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
                    ...
                    "specs": {
                        "$ref": "#/components/schemas/body.VmSpecs"
                    },
                    "sshConnectionString": {
                        "type": "string"
                    },
        ...
        "/v2/gpuClaims": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Admin detailed list",
                        "in": "query",
                        "name": "detailed",
                        "schema": {
                            "type": "boolean"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/body.GpuClaimCreate",
                                        "summary": "body",
                                        "description": "GpuClaim body"
                                    }
                                ]
                            }
                        }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/body.HostRead"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/body.VmSnapshotRead"
                                    },
                                    "type": "array"
                                }
                            }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/body.VmSnapshotCreated"
                                }
                            }
                        },
                        "description": "OK"
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/body.TimestampedSystemCapacities"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/body.TimestampedSystemStats"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/body.TimestampedSystemStatus"
                                    },
                                    "type": "array"
                                }
                            }
                    ...
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "items": {
                                        "$ref": "#/components/schemas/body.VmRead"
                                    },
                                    "type": "array"
                                }
                            }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/body.VmCreate",
                                        "summary": "body",
                                        "description": "VM body"
                                    }
                                ]
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/body.VmCreated"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/body.VmDeleted"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/body.VmUpdate",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/body.VmUpdated"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/body.VmSnapshotDeleted"
                                }
                            }
                        },
                        "description": "OK"
