...
import (
	...
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/artifact"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/auditlog"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/configure"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/gc"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/health"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/icon"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/immutable"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/jobservice"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/label"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/ldap"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/member"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/oidc"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/permissions"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/ping"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/preheat"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/project"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/project_metadata"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/purge"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/quota"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/registry"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/replication"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/repository"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/retention"
	...
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/scan"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/scan_all"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/scan_data_export"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/scanner"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/schedule"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/search"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/securityhub"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/statistic"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/system_cve_allowlist"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/systeminfo"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/user"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/usergroup"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/webhook"
	"github.com/kthcloud/go-deploy/pkg/imp/harbor/sdk/v2.0/client/webhookjob"
)
