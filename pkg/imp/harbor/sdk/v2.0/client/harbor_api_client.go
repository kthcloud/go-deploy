...
import (
	...
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/artifact"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/auditlog"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/configure"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/gc"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/health"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/icon"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/immutable"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/jobservice"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/label"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/ldap"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/member"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/oidc"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/permissions"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/ping"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/preheat"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/project"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/project_metadata"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/purge"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/quota"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/registry"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/replication"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/repository"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/retention"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/robot"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/robotv1"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/scan"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/scan_all"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/scan_data_export"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/scanner"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/schedule"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/search"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/securityhub"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/statistic"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/system_cve_allowlist"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/systeminfo"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/user"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/usergroup"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/webhook"
	"go-deploy/pkg/imp/harbor/sdk/v2.0/client/webhookjob"
)
